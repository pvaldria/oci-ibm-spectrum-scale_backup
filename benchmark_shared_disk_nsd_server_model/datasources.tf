...
data "template_file" "boot_script" {
  ...
  vars = {
    ...
    PrivateSubnetsFQDN        = "${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.private[0].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com"
    PrivateBSubnetsFQDN       = "${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.privateb[0].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com"
...
data "template_file" "mgmt_gui_boot_script" {
  ...
  vars = {
    ...
    SharedDataDiskCount           = var.SharedData["Count"]
    InstallerNode                 = "${var.ServerNodeHostnamePrefix}1"
    PrivateSubnetsFQDN            = "${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.private[0].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.private[1].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.private[2].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com"
    PrivateBSubnetsFQDN           = "${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.privateb[0].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.privateb[1].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com ${oci_core_subnet.privateb[2].dns_label}.${oci_core_virtual_network.ibmss_vcnv3.dns_label}.oraclevcn.com"
    CompanyName                   = var.CompanyName
    CompanyID                     = var.CompanyID
    CountryCode                   = var.CountryCode
